...
public class GestionPuntosConectividadActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void loadData() {
        ...
        mOpciones.add(new Opciones(LinearLayout.HORIZONTAL, 3, "Escanear QR", R.drawable.ic_item_arrow, R.color.colorFCEyT));
        mOpciones.add(new Opciones(LinearLayout.HORIZONTAL, 4, "Estadisticas", R.drawable.ic_item_arrow, R.color.colorFCEyT));
