...
public class ABMInscriptosActivity extends AppCompatActivity implements View.OnClickListener {
...
//        mDeportes.add(new Deporte(12, R.drawable.ic_voley_fem, "Voleibol Femenino", "Maryne Sanchez", "lunes, miércoles y viernes","21:30hs"));
        ...
        itemClickSupport.setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView parent, View view, int position, long id) {
                Intent i = new Intent(getApplicationContext(), InscriptosActivity.class);
