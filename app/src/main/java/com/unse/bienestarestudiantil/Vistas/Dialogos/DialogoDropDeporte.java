...
public class DialogoDropDeporte extends DialogFragment implements View.OnClickListener {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.dialogo_drop_deporte, container, false);
    ...
    private String processString(String token) {
        String data = "?idD=%s&key=%s";
        return String.format(data, mDeporte.getIdDep(), token);
    }

    public void sendServer(String data) {
        String URL = Utils.URL_DEPORTE_BAJA + data;
